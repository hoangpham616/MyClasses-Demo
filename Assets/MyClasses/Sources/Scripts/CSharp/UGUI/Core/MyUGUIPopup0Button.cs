 ...
 * Framework:   MyClasses
 * Class:       MyUGUIPopup0Button (version 2.18)
 */
...
namespace MyClasses.UI
{
    public class MyUGUIPopup0Button : MyUGUIPopup
    {
        ...
        /// Constructor.
        /// </summary>
        public MyUGUIPopup0Button(EPopupID id, string prefabNameCanvas, bool isFloat = false, bool isRepeatable = false)
        ...
        {
            string filePath = "Assets/Resources/" + MyUGUIManagerBase.POPUP_DIRECTORY + "Dialog0ButtonPopup" + subfixName + ".prefab";
