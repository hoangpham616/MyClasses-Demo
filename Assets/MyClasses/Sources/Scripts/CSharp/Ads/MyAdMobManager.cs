 ...
 * Framework:   MyClasses
 * Class:       MyAdMobManager (version 1.30)
 * Require:     GoogleMobileAds-v8.0.0
 * Require:     GoogleMobileAds-v7.1.0 (MY_ADMOB_7_1_0)
 */
...
namespace MyClasses
{
    public class MyAdMobManager : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (_bannerLoadedDelayFrameCallback > 0)
            {
                ...
                if (_bannerLoadedDelayFrameCallback == 0)
                {
                    ...
                    _lastBannerShowTimestamp = MyTime.CurrentUnixTime;
            ...
            if (_interstitialClosedDelayFrameCallback > 0)
            {
                ...
                if (_interstitialClosedDelayFrameCallback == 0)
                {
                    ...
                    _isLoadingInterstitial = false;
                    _lastInterstitialHideTimestamp = MyTime.CurrentUnixTime;
            ...
            if (_rewardedClosedDelayFrameCallback > 0)
            {
                ...
                {
                    _isLoadingRewarded = false;
                    _lastRewardedHideTimestamp = MyTime.CurrentUnixTime;
        ...
        public void ShowBanner(string adUnitId = null, AdSize size = null, AdPosition position = AdPosition.Bottom, Action onLoadedCallback = null, Action onFailedToLoadCallback = null, Action onOpeningCallback = null, Action onClosedCallback = null)
        {
            ...
            _lastBannerRequestTimestamp = MyTime.CurrentUnixTime;
#if UNITY_EDITOR
            _lastBannerShowTimestamp = MyTime.CurrentUnixTime;
#else
        ...
        public void LoadInterstitialAd(string adUnitId = null, Action onLoadedCallback = null, Action onFailedToLoadCallback = null)
        {
            ...
            {
                _interstitialAdRequest = new AdRequest();
            }
        ...
        public void LoadRewardedAd(string adUnitId = null, Action onLoadedCallback = null, Action onFailedToLoadCallback = null)
        {
            ...
            {
                _rewardedAdRequest = new AdRequest();
            }
        ...
        {
            return _appOpenAd != null && MyTime.CurrentUnixTime - _lastAppOpenRequestTimestamp < 14400000;
        }
        ...
        /// Load an app open  ad.
        /// </summary>
        public void LoadAppOpenAd(string adUnitId = null, Action onLoadedCallback = null, Action onFailedToLoadCallback = null)
        {
            if (_isTestMode)
            {
#if UNITY_ANDROID
...
#if DEBUG_MY_ADMOB
            Debug.Log("[" + typeof(MyAdMobManager).Name + "] LoadAppOpenAd(): adUnitId=" + adUnitId);
#endif
            ...
            {
                _appOpenAdRequest = new AdRequest();
            }
            
#if MY_ADMOB_7_1_0
            AppOpenAd.LoadAd(adUnitId, ScreenOrientation.Portrait, _appOpenAdRequest, ((appOpenAd, error) =>
            {
                ...
                else
                {
                    ...
                    _lastAppOpenRequestTimestamp = MyTime.CurrentUnixTime;
            ...
            AppOpenAd.Load(adUnitId, _appOpenAdRequest, (AppOpenAd ad, LoadAdError error) =>
            {
                if (error != null || ad == null)
                {
#if DEBUG_MY_ADMOB
        ...
        private void _OnAppOpenAdClosed()
        {
            ...
            _appOpenAd = null;
            _isShowingAppOpen = false;
            _lastAppOpenHideTimestamp = MyTime.CurrentUnixTime;
