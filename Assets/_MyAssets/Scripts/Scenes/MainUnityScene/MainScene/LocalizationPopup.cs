...
namespace MyApp
{
    public class LocalizationPopup : MyUGUIPopup
    {
        ...
        public LocalizationPopup(EPopupID id, string prefabNameCanvas, string prefabName3D, string addressableCanvas, string addressable3D, bool isRepeatable = false)
